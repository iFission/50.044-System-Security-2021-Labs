...
//SHA-256 source code obtained from https://github.com/B-Con/crypto-algorithms
...
int main(int argc, char * argv[]){
	...
	//We need 2 arguments "program filename"
	if(argc < 2){
		printf("Insufficient arguments, enter filename\n");
		return 1;
	}
	...
	BYTE * buffer = (BYTE *) malloc(sourceFileSize);
